...
\Acrshort{vl} model aims to align vision and language information to perform complex task, multimodal task, which require reasoning with both vision and language modalities, e.g., image captioning, visual question answering and multimodal retrieval.
In the early stage of \acrshort{vl}, many models adopt CNN and RNN as a feature extractor for image and text with a multi layer perceptron to combine image and text feature. 
With the upcoming of CLIP model \cite{clip}, 
